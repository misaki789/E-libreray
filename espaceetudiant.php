...
<?php 
        if(isset($_SESSION['etudiant'])){
            ...
            <a href="espaceetudiant.php">profile</a><br><br><br>
            <?php
        }
    ?>
    <header class="header">
                ...
                <div class="movie-list-wrapper" >
                    <div class="movie-list" >
                        <div class="movie-list-item"  >
                            ...
                            <a href="pdfs/To Kill A Mockingbird - Full Text PDF.pdf" id="a1"><button class="movie-list-item-button">Read</button></a>
                        </div>
                        <div class="movie-list-item" id="movie-list-item">
                            ...
                            <a href="pdfs/Gatsby_PDF_FullText.pdf"><button class="movie-list-item-button">Read</button></a>
                        </div>
                        <div class="movie-list-item">
                            ...
                            <a href="pdfs/solitude.pdfs"><button class="movie-list-item-button">Read</button></a>
                        </div>
                        <div class="movie-list-item">
                            ...
                            <button class="movie-list-item-button">Read</button>
                        </div>
                        <div class="movie-list-item" id="id2">
                            ...
                            <a href="imagebib/Ralph Ellison - Invisible Man v3_0.pdf"><button class="movie-list-item-button">Read</button></a>
                        </div>
                        <div class="movie-list-item">
                            ...
                            <a href="imagebib/_OceanofPDF.com_The_Alchemist.pdf"><button class="movie-list-item-button">Read</button></a>
                        </div>
                    </div>
                ...
                <div class="movie-list-wrapper" >
                    <div class="movie-list" >
                        <div class="movie-list-item">
                            ...
                            <a href="imagebib/kant-first-critique-cambridge-1m89prv.pdf"><button class="movie-list-item-button">Read</button></a>
                        </div>
                        <div class="movie-list-item">
                            ...
                            <a href="imagebib/Dostoievski-idiot-1.pdf"><button class="movie-list-item-button">Read</button></a>
                        </div>
                        <div class="movie-list-item">
                        ...
                        <div class="movie-list-item">
                            ...
                            <a href="imagebib/meditations.pdf"><button class="movie-list-item-button">Read</button></a>
                        </div>
                        <div class="movie-list-item">
                            ...
                            <a href="imagebib/Prince-Adapted2.pdf"><button class="movie-list-item-button">Read</button></a>
                        </div>
                        <div class="movie-list-item">
                            ...
                            <a href="imagebib/ethicsbook.pdf"><button class="movie-list-item-button">Read</button></a>
                        </div>
                    </div>
                    <i class="fas fa-chevron-right arrow"></i>
                </div>
                ...
                <div class="movie-list-wrapper">
                    <div class="movie-list">
                        <div class="movie-list-item">
                            ...
                            <a href="imagebib/Rich Dad Poor Dad ( PDFDrive ).pdf"><button class="movie-list-item-button">read</button></a>
                        </div>
                        <div class="movie-list-item">
                            ...
                            <a href="imagebib/isaacson-walter-isaacson-steve-jobs.pdf"><button class="movie-list-item-button">read</button></a>
                        </div>
                        <div class="movie-list-item">
                            ...
                            <a href="imagebib/Think-And-Grow-Rich.pdf"><button class="movie-list-item-button">Read</button></a>
                        </div>
                        <div class="movie-list-item">
                            ...
                            <a href="imagebib/the-4-hour-workweek-expanded-and-updated-by-timothy-ferriss.pdf"><button class="movie-list-item-button">Read</button></a>
                        </div>
                        <div class="movie-list-item">
                            ...
                            <a href="imagebib/IntroductionToBusiness-OP.pdf"><button class="movie-list-item-button">Read</button></a>
                        </div>
                        <div class="movie-list-item">
                            ...
                            <button class="imagebib/movie-list-item-button">Read</button>
                        </div>
                    </div>
                    <i class="fas fa-chevron-right arrow"></i>
                </div>
